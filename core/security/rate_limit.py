...
from core.config.config import (
    RATE_LIMIT_CART_MUTATION_MAX_REQUESTS,
    RATE_LIMIT_CART_MUTATION_WINDOW_SECONDS,
    RATE_LIMIT_FORGET_PASSWORD_MAX_REQUESTS,
    RATE_LIMIT_FORGET_PASSWORD_WINDOW_SECONDS,
    RATE_LIMIT_LOGIN_MAX_REQUESTS,
    RATE_LIMIT_LOGIN_WINDOW_SECONDS,
    RATE_LIMIT_MENU_BOOTSTRAP_MAX_REQUESTS,
    RATE_LIMIT_MENU_BOOTSTRAP_WINDOW_SECONDS,
